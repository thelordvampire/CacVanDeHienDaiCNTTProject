package fr.neamar.kiss.grid_view;
...
//    }
    ...
    public BaseDynamicGridAdapter(Context context, List<App> items, int columnCount) {
        mContext = context;
        mColumnCount = columnCount;
        init(items);
    }
...
//    }
    ...
    private void init(List<App> items) {
        addAllStableId(items);
        this.mItems.addAll(items);
    }
...
//    }
    ...
    public void set(List<App> items) {
        clear();
        init(items);
        notifyDataSetChanged();
    }
...
//    }
    ...
    public void add(List<App> items) {
        addAllStableId(items);
        this.mItems.addAll(items);
        notifyDataSetChanged();
    }
